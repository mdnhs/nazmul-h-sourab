...
5. **Educations**: Showcase your Educations in `config/Educations.ts`
...
- Built by [Nazmul H. Sourab](https://github.com/mdnhs)
...
**Built with ❤️ by [Naman Nazmul H. Sourab](https://github.com/mdnhs)**
